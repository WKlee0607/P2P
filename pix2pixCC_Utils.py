...
class Manager(object):
    ...
    def save(self, package, image=False, model=False):
        if image:
            ...
            path_D = os.path.join(self.opt.model_dir, str(package['Epoch']) + '_' + 'D.pt')
            path_G = os.path.join(self.opt.model_dir, str(package['Epoch']) + '_' + 'G.pt')
    ...
    def __call__(self, package):
        ...
        if package['total_step'] / package['current_step'] == package['Epoch'] + 1:
